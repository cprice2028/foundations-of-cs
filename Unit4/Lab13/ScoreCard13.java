...
public class ScoreCard13 extends JPanel
{
   ...
   public void randomize()
   {
      for(int r = 0; r < input.length; ++r)
      {
         ...
         {
            input[r][col].setText("" + (int)(Math.random() * 4.0D + 1.0D));
         }
      }
   }
   public int findTotal(int r)
   {
      ...
      {
         a += Integer.parseInt(input[r][x].getText());
      }
   ...
   public int findAces(int r)
   {
      ...
      for(int col = 0; col < input[0].length; col++) 
      {
         if (Integer.parseInt(input[r][col].getText()) == 1) 
         {
            ++aces;
         }
      }
   ...
   public int findHardestHole()
   {
      ...
      for(int c = 0; c < input[0].length; c++) {
         ...
         for(int r = 0; r < input.length; r++) {
            vertical += Integer.parseInt(input[r][c].getText());
         }
